...
export default class qb_SfToqbRelFieldsMappingComp extends LightningElement {
    @api relatedDataList;
    ...
    connectedCallback() {
        ...
        ////console.log('cpChildobject>>' + sfChildobject);
        ////console.log('cpChildobject>>' + JSON.stringify(this.cpChildObjectFields));
        ////console.log('relatedDataList>>' + JSON.stringify(this.relatedDataList));
        ////console.log('relatedDataList2>>' + this.relatedDataList);
        // let referenceFieldListTemp = JSON.stringify(this.relatedDataList);
        ////console.log('vm.RelatedMappingDataList.length -- 56',vm.RelatedMappingDataList.length);
        ...
        if (sfChildobject) {
            sObjFieldsList({ sobjectName: sfChildobject }).then(result => {
                ...
                ////console.log('sfchildObjectFieldList_Check>>', JSON.stringify(this.sfchildObjectFieldList));
                vm.RelatedMappingDataList = vm.relatedDataList;
                // ////console.log('relatedMapping1==>', vm.RelatedMappingDataList);
                // ////console.log('relatedMapping2==>', vm.relatedDataList);
                // ////console.log('relatedMapping3==>', JSON.stringify(this.relatedDataList));


                /*for (var value in this.relatedDataList) {
                    if (this.relatedDataList[value].sfreferenceObj) {
                        ////console.log('pavalue1', this.relatedDataList[value].sfreferenceObj);
                        this.ReferenceListTemp.push(this.relatedDataList[value].sfreferenceObj);
                        // strValue was non-empty string, true, 42, Infinity, [], ...
                    }
                    ////console.log('pavalue2', this.relatedDataList[value].sfreferenceObj);
                    ////console.log('pavalue3', this.ReferenceListTemp);
                }*/
                //     sObjFieldsList({ sobjectName: referenceObj }).then(result => {
                //         this.inProgress = false;
                //         this.referenceFieldList = result;
                //         ////console.log('primary_referenceFieldList>>' + JSON.stringify(this.referenceFieldList));
                //     }); 
    ...
    async setUpdatedValuetochildObjMapRec(event) {
        ...
        let dataVal;
        // let fieldType = '';
        ////console.log('event.currentTarget.type>>', JSON.stringify(event.currentTarget));
        ////console.log('event.currentTarget.type>>', event.currentTarget.dataset.type);
        ////console.log('event_Details>>', JSON.stringify(event.detail));
        ////console.log('event_configId>>', configId);
        ...
        try{
            ...
            ////console.log('before_RelatedMappingDataList>>', JSON.stringify(this.RelatedMappingDataList));
            ////console.log('before_VisibleRelatedMappingDataList>>', JSON.stringify(this.VisibleRelatedMappingDataList));
            let RelatedMappingDataListTemp = [];
            var VisibleRelatedMappingDataListTemp = [];
            ////console.log('Test Check Promise>>');
            if (this.VisibleRelatedMappingDataList) {
                ...
                ////console.log('Inside_RelatedMappingDataList>>', this.VisibleRelatedMappingDataList);
                ...
                for (let element of this.VisibleRelatedMappingDataList) {
                    ...
                    ////console.log('Test Check Promise1>>');
                    ////console.log('Inside_RelatedMappingDataListForEach>>', element.configId);
                    if (element.configId === configId) {
                        ////console.log('Inside_IfRelatedMappingDataListForEach>>');
                        let eachConfigRow = element;
                        let eachConfigRowVisible = element;
                        eachConfigRow = { ...eachConfigRow, [event.currentTarget.name]: dataVal };
                        ////console.log('eachConfigRow>>', eachConfigRow);
                        eachConfigRowVisible = { ...eachConfigRowVisible, [event.currentTarget.name]: dataVal };
                        ////console.log('eachConfigRowVisible>>', eachConfigRowVisible);
                        ...
                        if (dataVal) {
                            if (event.currentTarget.dataset.type === 'primary') {
                                ...
                                ////console.log('sfFieldOptions>>', JSON.stringify(sfFieldOptions));
                                if (sfFieldOptions) {
                                    // sfFieldOptions.forEach(fldElement => {  // Nested_For_Each_Loop
                                    for (let fldElement of sfFieldOptions) {
    
                                        ////console.log('fldElement.value>>', fldElement.value);
                                        if (fldElement.value === dataVal) {
                                            ////console.log('selectedfieldName>>', dataVal);
                                    ...
                                    ////console.log('primary_eachConfigRow>>', JSON.stringify(eachConfigRow));
                                    ////console.log('primary_eachConfigRowVisible>>', JSON.stringify(eachConfigRowVisible));
                                }
                                if (isRefField) {
                                    ...
                                    await sObjFieldsList({ sobjectName: referenceObj }).then(result => {
                                        ...
                                        ////console.log('eachConfigRowVisible1==>>', eachConfigRowVisible);
                                        // ////console.log('primary_eachConfigRowVisible>>' + JSON.stringify(this.eachConfigRowVisible));
                                    }).catch(error => {
                                        this.error = error;
                                        ////console.log(this.error);
                                    });
                                ...
                                if (sfField2Options) {
                                    ...
                                    // });
                                    ////console.log('secondary_eachConfigRow>>', JSON.stringify(eachConfigRow));
                                }
                                /*if (isRefField2) {
                                    this.inProgress = true;
                                    await sObjFieldsList({ sobjectName: referenceObj2 }).then(result => {
                                        ...
                                        ////console.log('secondary_referenceField2List>>' + JSON.stringify(this.referenceField2List));
                                    });
                                }*/
                            }
                        }
                        ////console.log('InBetweenPromise1&2_Reference');
                        RelatedMappingDataListTemp = [...RelatedMappingDataListTemp, JSON.parse(JSON.stringify(eachConfigRow))];
                        ////console.log('eachConfigRowVisible2==>>', eachConfigRowVisible);
                        VisibleRelatedMappingDataListTemp = [...VisibleRelatedMappingDataListTemp, eachConfigRowVisible];
    
                    } else {
                        ////console.log('InBetweenPromise1&2');
                    ...
                    ////console.log('Test Check Promise2>>');
                }
                // });
                // ////console.log('innerPromiseArr_value>>', value);
                ////console.log('Test Check Promise3>>');
                ...
                ////console.log('RelatedMappingDataList_inPromiseAll>>', JSON.stringify(this.RelatedMappingDataList));
                ////console.log('VisibleRelatedMappingDataList_inPromiseAll>>', JSON.stringify(this.VisibleRelatedMappingDataList));
    
                //Remove referencedFieldList from RelatedMappingDataListTemp
                ////console.log('remove_ReferenceFieldsListfromMainList>>');
                    ...
                    this.RelatedMappingDataList.forEach(function (element) {
                        Object.keys(element).forEach(function (key) {
                            if (key.startsWith('referenceField') && key.endsWith('List')) {
                                ////console.log('referenceField_key>>', key);
                                delete element[key];
                            }
                        });
                    });
            ...
            // ////console.log('outerPromiseArr_value>>', value);
            ////console.log('Test Check Promise4>>');
            ////console.log('After_RelatedMappingDataList>>', JSON.stringify(this.RelatedMappingDataList));
            ////console.log('After_VisibleRelatedMappingDataList>>', JSON.stringify(this.VisibleRelatedMappingDataList));
    ...
    async addMappingFunction() {
        ...
        if (this.RelatedMappingDataList) {
            ...
            for (let element of this.RelatedMappingDataList) {
                ////console.log('addMappingFunction_PromiseCheck1');
                // RelatedMappingDataListTemp = [...RelatedMappingDataListTemp, element];
                // VisibleRelatedMappingDataListTemp = [...VisibleRelatedMappingDataListTemp, element];
                // promise.push(new Promise(async (resolve, reject) => {
                ////console.log('addMappingFunction_PromiseCheck2');
                ////console.log('element.isReferenceMapping>>', element.isReferenceMapping);
                let eachConfigRow = element;
                if (element.isReferenceMapping) {
                    ...
                    ////console.log('referenceCountInt>>', referenceCountInt);
                ...
                ////console.log('addMappingFunction_PromiseCheck3');
                // resolve(null);
                // }));
            }

            // });
            ////console.log('addMappingFunction_PromiseCheck4');
            // Promise.all(promise).then(() => {
            vm.VisibleRelatedMappingDataList = VisibleRelatedMappingDataListTemp;
            ////console.log('RelatedMappingDataList_ConCall>>', JSON.stringify(vm.RelatedMappingDataList));
            ////console.log('VisibleRelatedMappingDataList_ConCall>>', JSON.stringify(vm.VisibleRelatedMappingDataList));
            // });
        }
    }

    addBlankMappingFunction() {
        ////console.log('In_addBlankMappingFunction>>');
        let RelatedMappingDataListTemp = new Array();
        let VisibleRelatedMappingDataListTemp = new Array();
        if (this.VisibleRelatedMappingDataList) {
            ////console.log('In_If>>');
            ////console.log('Line_303_RelatedMappingDataList>>', JSON.stringify(this.RelatedMappingDataList));
            ////console.log('Line_303_VisibleRelatedMappingDataList>>', JSON.stringify(this.VisibleRelatedMappingDataList));
            this.VisibleRelatedMappingDataList.forEach(function (element) {
                ////console.log('Element_Line_316', JSON.stringify(element));
                RelatedMappingDataListTemp = [...RelatedMappingDataListTemp, JSON.parse(JSON.stringify(element))];
                VisibleRelatedMappingDataListTemp = [...VisibleRelatedMappingDataListTemp, element];
                ////console.log('In_Loop>>');
            });
        }
        ////console.log('Line_no_326_RelatedMappingDataList>>', JSON.stringify(RelatedMappingDataListTemp));
        ////console.log('Line_no_327_VisibleRelatedMappingDataList>>', JSON.stringify(VisibleRelatedMappingDataListTemp));
        //Remove referencedFieldList from RelatedMappingDataListTemp
        ////console.log('remove_ReferenceFieldsListfromMainList>>');
        ...
        ////console.log('afterRemovingReferenceList_RelatedMappingDataListTemp>>', JSON.stringify(RelatedMappingDataListTemp));
        ////console.log('afterRemovingReferenceList_VisibleRelatedMappingDataListTemp>>', JSON.stringify(VisibleRelatedMappingDataListTemp));
        ...
        this.RelatedMappingDataList = RelatedMappingDataListTemp;
        this.VisibleRelatedMappingDataList = VisibleRelatedMappingDataListTemp;
        ////console.log('Final_RelatedMappingDataList>>', JSON.stringify(RelatedMappingDataListTemp));
        ////console.log('Final_VisibleRelatedMappingDataList>>', JSON.stringify(VisibleRelatedMappingDataListTemp));
    ...
    removeMappingFunction(event) {
        ...
        ////console.log('Final_RelatedMappingDataList>>', JSON.stringify(this.RelatedMappingDataList));
        ////console.log('Final_VisibleRelatedMappingDataList>>', JSON.stringify(this.VisibleRelatedMappingDataList));
        ////console.log('related Length ==> ',this.RelatedMappingDataList.length);
        ////console.log('Final_VisibleRelatedMappingDataList Length ==> ',this.VisibleRelatedMappingDataList.length);
